...
const INITIAL_MESSAGES = [
  {
    role: 'bot',
    text: "Hi! I'm Glamour AI ✨ — your personal beauty assistant. Ask me about our services, pricing, or how to book an appointment!",
  },
];
      ...
      {open && (
        <div className="chatbot-popup glass" style={{ background: 'var(--bg-card)', border: '1px solid var(--border)' }}>
          ...
          <div style={{
            ...
            <div>
              <div style={{ color: 'white', fontWeight: '700', fontSize: '0.95rem' }}>Glamour AI</div>
